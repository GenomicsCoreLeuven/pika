...
#write.csv(summary(d$prior.df), file=paste(condition1, "_vs_", condition2, ".dispersions.summary.txt", sep = ""))
#fileConn<-file(paste(condition1, "_vs_", condition2, ".dispersions.summary.txt", sep = ""))
#writeLines(summary(d$prior.df),fileConn)
#close(fileConn)
